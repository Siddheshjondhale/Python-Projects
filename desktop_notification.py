...
#labels
titleLabel = Label(tkin, text='Title of the notification').grid(row=0,column=0,)
...
#button
button = Button(tkin, text='Stop', width=25,command=data).place(x=0,y=85)
...
#nd.notify(label1, message='Test 123', app_name='12', app_icon='', timeout=10, toast=False,)
